...
const NATURAL = ["Граніт", "Лабрадорит", "Мармур", "Кварцит"]

const FAMILY_ORDER = ["Граніт", "Лабрадорит", "Мармур", "Кварцит"]
...
const FAMILY_NOTE: Record<string, string> = {
  ...
  Кварцит: "Твердість граніту, рисунок мармуру. Для дому — стільниці й острови; на кладовищі не використовуємо.",
}
        ...
        <div className="mt-12 flex flex-col gap-4 rounded-3xl bg-secondary/60 p-6 md:flex-row md:items-center md:justify-between md:p-8">
          <div>
            ...
            <p className="mt-1.5 max-w-2xl text-[15px] text-muted-foreground">
              ...
              колір, непориста поверхня, будь-який формат. На кладовище не йде, на кухню — найчастіше.
            </p>
          </div>
          <Link
