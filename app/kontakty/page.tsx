  ...
  return (
    <>
      ...
      >
        ...
        <CtaBand title="Не хочете дзвонити — залиште заявку" text="Оберіть модель у каталозі або просто опишіть, що потрібно. Передзвонимо в робочий час, без нав'язливих дзвінків потім." cta="Залишити заявку" />
      </InfoPage>
    </>
  )
}
