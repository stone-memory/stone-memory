...
const uk: Dictionary = {
  ...
  hero: {
    ...
    subtitle: "Пам'ятники, сімейні та військові меморіальні комплекси, надгробні плити. Український граніт, габро й мармур, а також імпортні породи. Власне виробництво в Костополі.",
...
const pl: Dictionary = {
  ...
  hero: {
    ...
    subtitle: "Pomniki, rodzinne i wojskowe kompleksy memorialne, płyty nagrobne. Ukraiński granit, gabro i marmur oraz gatunki importowane. Własna produkcja w Kostopolu.",
...
const en: Dictionary = {
  ...
  hero: {
    ...
    title: "Natural Stone",
    subtitle: "Monuments, family and military memorial complexes, grave slabs. Ukrainian granite, gabbro and marble plus premium imports. Crafted in our Kostopil workshop.",
...
const de: Dictionary = {
  ...
  hero: {
    ...
    title: "Naturstein",
    subtitle: "Grabmale, Familien- und Militär-Gedenkkomplexe, Grabplatten. Ukrainischer Granit, Gabbro und Marmor sowie Importsorten. Gefertigt in unserer Werkstatt in Kostopil.",
...
const lt: Dictionary = {
  ...
  hero: {
    ...
    subtitle: "Paminklai, šeimos ir karių memorialiniai kompleksai, kapo plokštės. Ukrainietiškas granitas, gabbras ir marmuras bei importas. Pagaminta mūsų dirbtuvėje Kostopilyje.",
