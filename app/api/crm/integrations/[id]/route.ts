...
function getEnvKeyFor(id: IntegrationId, key: string): string | null {
  const map: Record<IntegrationId, Record<string, string>> = {
    ...
    email_mailbox: { address: "EMAIL_MAILBOX_ADDRESS", app_password: "EMAIL_MAILBOX_APP_PASSWORD", imap_host: "EMAIL_IMAP_HOST", imap_port: "EMAIL_IMAP_PORT", imap_folder: "EMAIL_IMAP_FOLDER", smtp_host: "EMAIL_SMTP_HOST", smtp_port: "EMAIL_SMTP_PORT" },
