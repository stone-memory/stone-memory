  ...
  return (
    <>
      ...
      >
        ...
        <CtaBand title="Лишилось питання?" text="Напишіть у Viber або Telegram — відповідає майстер, а не бот. Або залиште заявку, і ми передзвонимо в робочий час." cta="Поставити питання" />
      </InfoPage>
    </>
  )
}
