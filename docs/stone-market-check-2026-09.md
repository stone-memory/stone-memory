...
взагалі й чим замінити. Попередня звірка (вересень 2026, за даними stone-scraper) дивилась лише на
ukr.granite.ua та 8 меморіальних сайтів, де імпорту немає в товарах. Тут узято продавців слябів і штучного каменю.
