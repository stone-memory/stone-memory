...
export const metadata: Metadata = {
  ...
  description:
    "Реалізовані проєкти Stone Memory: одиночні пам'ятники, сімейні та військові меморіальні комплекси, благоустрій поховань. Ручна обробка в Костополі.",
  alternates: {
    canonical: absoluteUrl(PATH),
  },
  openGraph: {
    title: "Stone Memory — Проєкти",
    description: "Реалізовані проєкти — пам'ятники, меморіальні комплекси, благоустрій поховань.",
