...
const uk: Dictionary = {
  ...
  hero: {
    ...
    subtitle: "Пам'ятники та меморіальні комплекси — і кам'яні поверхні для дому й архітектури. Український граніт, габро, лабрадорит і мармур, власний цех у Костополі, монтаж по всій Україні.",
