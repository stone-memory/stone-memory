...
const STEPS = [
  {
    ...
    text: "Надішліть фото місця в месенджер або через форму.",
  },
  {
    title: "Ескіз і ціна за день",
    text: "Протягом робочого дня повертаємось із ескізом й розрахунком. Правки безкоштовні, поки не почали різати камінь.",
  },
  {
