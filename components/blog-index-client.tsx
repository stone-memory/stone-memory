...
import { categoryTitles, type Article, type ArticleCategory } from "@/lib/data/articles"
...
/**
 * Article list arrives from the server so the nine posts are linked in the
 * initial HTML — this index previously rendered only the heading, leaving the
 * whole journal unreachable by crawl.
 */
export function BlogIndexClient({ initialArticles }: { initialArticles: Article[] }) {
