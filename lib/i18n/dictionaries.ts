...
const uk: Dictionary = {
  ...
  hero: {
    badge: "КОСТОПІЛЬ · ВЛАСНЕ ВИРОБНИЦТВО",
    title: "Майстерня натурального каменю",
    subtitle: "Пам'ятники, меморіальні комплекси та кам'яні поверхні для дому й архітектури. Український граніт, габро, лабрадорит і мармур, власний цех у Костополі, монтаж по всій Україні.",
    ctaPrimary: "Пам'ятники",
    ctaSecondary: "Архітектурний камінь",
  },
  catalog: {
    label: "КАТАЛОГ",
    heading: "Камінь, що зберігає пам'ять",
    subheading: "Одиночні та подвійні пам'ятники, меморіальні комплекси, хрести й обеліски. Український граніт і габро, а також імпорт — індійський і китайський граніт. Виготовляємо у власному цеху.",
    count: "позицій",
    fromPrice: "від",
  ...
  footer: {
    ...
    subscribeDesc: "Нові колекції, історії клієнтів і гайди.",
...
const pl: Dictionary = {
  ...
  hero: {
    badge: "KOSTOPOL · WŁASNA PRODUKCJA",
    title: "Pracownia kamienia naturalnego",
    subtitle: "Pomniki i kompleksy memorialne — oraz kamienne powierzchnie do domu i architektury. Ukraiński granit, gabro, labradoryt i marmur, własny zakład w Kostopolu.",
    ctaPrimary: "Pomniki",
    ctaSecondary: "Kamień architektoniczny",
  },
  catalog: {
    label: "KATALOG",
...
const en: Dictionary = {
  ...
  hero: {
    badge: "KOSTOPIL · OWN WORKSHOP",
    title: "Natural stone workshop",
    subtitle: "Monuments and memorial complexes — and stone surfaces for homes and architecture. Ukrainian granite, gabbro, labradorite and marble, cut in our own Kostopil workshop.",
    ctaPrimary: "Monuments",
    ctaSecondary: "Architectural stone",
  },
  catalog: {
    label: "CATALOG",
...
const de: Dictionary = {
  ...
  hero: {
    badge: "KOSTOPIL · EIGENE WERKSTATT",
    title: "Werkstatt für Naturstein",
    subtitle: "Grabmale und Gedenkkomplexe — und Steinflächen für Haus und Architektur. Ukrainischer Granit, Gabbro, Labradorit und Marmor aus unserer Werkstatt in Kostopil.",
    ctaPrimary: "Grabmale",
    ctaSecondary: "Architekturstein",
  },
  catalog: {
    label: "KATALOG",
...
const lt: Dictionary = {
  ...
  hero: {
    badge: "KOSTOPILIS · SAVA GAMYBA",
    title: "Natūralaus akmens dirbtuvės",
    subtitle: "Paminklai ir memorialiniai kompleksai — ir akmens paviršiai namams bei architektūrai. Ukrainietiškas granitas, gabras, labradoritas ir marmuras iš mūsų dirbtuvių Kostopilyje.",
    ctaPrimary: "Paminklai",
    ctaSecondary: "Architektūrinis akmuo",
  },
  catalog: {
    label: "KATALOGAS",
