...
export function PortfolioFallback({ stones }: { stones: StoneItem[] }) {
  ...
  return (
    ...
    >
      ...
      <CtaBand title="Хочете так само?" text="Надішліть фото ділянки й роботу, яка сподобалась, — зробимо ескіз у вашому камені й порахуємо вартість." cta="Надіслати фото і приклад" />
    </InfoPage>
  )
}
