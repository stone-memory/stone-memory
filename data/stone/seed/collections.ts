...
const make = (
  ...
  return {
    ...
    name,
    material:
      ['Граніт', 'Габро', 'Базальт', 'Лабрадорит', 'Пісковик'].includes(family)
        ? 'granit'
        : family === 'Мармур'
          ? 'marmur'
          : family === 'Кварцит'
...
const ukrainian: [string, string, string, string, string, string[]][] = [
  ...
  // Додані у вересні 2026 після звірки з ринком; фото з партій 1–2 генератора.
  ['chovnovske', 'Човновський граніт (Chovnovske)', 'Граніт', 'Житомирська область, Україна', 'темно-зелений', ['стільниці', 'сходи', 'фасади']],
  ['rogovske', 'Рогівський граніт (Rogovske)', 'Граніт', 'Житомирська область, Україна', 'сіро-зелений', ['стільниці', 'сходи', 'фасади', 'бруківка']],
  ['zhadani', 'Жаданівський граніт (Zhadani)', 'Граніт', 'Житомирська область, Україна', 'коричневий', ['стільниці', 'сходи', 'фасади']],
  ['rosa-raveno', 'Жадьківський граніт (Rosa Raveno)', 'Граніт', 'Рівненська область, Україна', 'коричнево-рожевий', ['стільниці', 'сходи', 'фасади']],
  ['granat', 'Крутнівський граніт (Granat)', 'Граніт', 'Житомирська область, Україна', 'рожевий', ['стільниці', 'сходи', 'фасади']],
  ['dmytrit', 'Юр’ївський граніт (Dmytrit)', 'Граніт', 'Житомирська область, Україна', 'рожево-сірий', ['стільниці', 'підвіконня', 'фасади']],
  ['voinivske', 'Войнівський граніт (Rosso Santiago)', 'Граніт', 'Кіровоградська область, Україна', 'червоний', ['стільниці', 'сходи', 'фасади', 'бруківка']],
  ['rakhni-polivsky', 'Рахни-Полівський граніт (Rakhni-Polivsky)', 'Граніт', 'Вінницька область, Україна', 'чорний', ['стільниці', 'каміни', 'фасади']],
  ['galactic-blue', 'Очеретянський лабрадорит (Galactic Blue)', 'Лабрадорит', 'Житомирська область, Україна', 'чорний із синім переливом', ['стільниці', 'каміни', 'фасади']],
]
 ...
 * конкурента (14; 9 із них уже з фото перенесені в `ukrainian`). Решта
 * заведені в базу прихованими: фото за правилами
...
const ukrainianPending: [string, string, string, string, string, string[]][] = [
  ['silver-grey', 'Ковалівський лабрадорит (Silver Grey)', 'Лабрадорит', 'Житомирська область, Україна', 'сіро-чорний', ['стільниці', 'каміни', 'фасади']],
  ['fantasy-azure', 'Слобідський лабрадорит (Fantasy Azure)', 'Лабрадорит', 'Житомирська область, Україна', 'чорно-синій', ['стільниці', 'каміни', 'фасади']],
  ['lukovetskyi', 'Луковецький анортозит (Lukovetskiy)', 'Лабрадорит', 'Житомирська область, Україна', 'сіро-зелений', ['стільниці', 'сходи', 'фасади']],
  ['ovrutskyi', 'Овруцький кварцит', 'Кварцит', 'Житомирська область, Україна', 'рожево-червоний', ['бруківка', 'фасади', 'сходи']],
  ['terebovlianskyi', 'Теребовлянський пісковик', 'Пісковик', 'Тернопільська область, Україна', 'сіро-зелений', ['фасади', 'облицювання', 'бруківка']],
]
